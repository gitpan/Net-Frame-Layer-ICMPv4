#
# $Id: DestUnreach.pm,v 1.1 2006/12/17 16:17:03 gomor Exp $
#
...
Net::Frame::Layer::ICMPv4::DestUnreach - ICMPv4 DestUnreach type object

=head1 SYNOPSIS

   use Net::Frame::Layer::ICMPv4::DestUnreach;

   my $layer = Net::Frame::Layer::ICMPv4::DestUnreach->new(
      unused  => 0,
      payload => '',
   );
   $layer->pack;
   ...
   # Read a raw layer
   my $layer = Net::Frame::Layer::ICMPv4::DestUnreach->new(raw => $raw);
