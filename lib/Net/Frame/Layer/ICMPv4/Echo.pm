#
# $Id: Echo.pm,v 1.1 2006/12/17 16:17:03 gomor Exp $
#
package Net::Frame::Layer::ICMPv4::Echo;
use strict;
use warnings;
...
Net::Frame::Layer::ICMPv4::Echo - ICMPv4 Echo type object

=head1 SYNOPSIS

   use Net::Frame::Layer::ICMPv4::Echo;

   my $layer = Net::Frame::Layer::ICMPv4::Echo->new(
      identifier     => getRandom16bitsInt(),
      sequenceNumber => getRandom16bitsInt(),
      payload        => '',
   );
   ...
   # Read a raw layer
   my $layer = Net::Frame::Layer::ICMPv4::Echo->new(raw => $raw);
