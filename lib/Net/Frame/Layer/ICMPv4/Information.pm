#
# $Id: Information.pm,v 1.1 2006/12/17 16:17:03 gomor Exp $
#
package Net::Frame::Layer::ICMPv4::Information;
use strict;
use warnings;
...
Net::Frame::Layer::ICMPv4::Information - ICMPv4 Information type object

=head1 SYNOPSIS

   use Net::Frame::Layer::ICMPv4::Information;

   my $layer = Net::Frame::Layer::ICMPv4::Information->new(
      identifier     => getRandom16bitsInt(),
      sequenceNumber => getRandom16bitsInt(),
      payload        => '',
   );
   ...
   # Read a raw layer
   my $layer = Net::Frame::Layer::ICMPv4::Information->new(raw => $raw);
